...
#
# radio_periph_lab.tcl: Tcl script for re-creating project 'radio_periph_lab'
#
# Generated by Vivado on Sun Aug 13 14:11:16 -0400 2023
...
#
# 1. This project restoration tcl script (radio_periph_lab.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/FPGA/FPGA_SoC/Lab6_Hicks/radio_periph_labmain/radio_periph_labmain/vivado/radio_periph_lab.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "C:/FPGA/FPGA_SoC/Lab6_Hicks/radio_periph_labmain/radio_periph_labmain/src/toplevel.vhd"
#    "C:/FPGA/FPGA_SoC/Lab6_Hicks/radio_periph_labmain/radio_periph_labmain/src/toplevel.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../vivado/radio_periph_lab.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/../../src/toplevel.vhd"]"\
 "[file normalize "$origin_dir/../../src/toplevel.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../vivado/"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "radio_periph_lab"
...
set script_file "radio_periph_lab.tcl"
...
set file "$origin_dir/../../src/toplevel.vhd"
...
set file "[file normalize "$origin_dir/../../src/toplevel.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../../src/toplevel.xdc"
set file [file normalize $file]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
  ...
  connect_bd_net -net rst_ps7_0_125M_peripheral_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_125M/peripheral_aresetn] [get_bd_pins xpm_cdc_gen_0/src_rst]
  connect_bd_net -net rst_ps7_0_125M_peripheral_reset [get_bd_pins rst_ps7_0_125M/peripheral_reset]
  connect_bd_net -net s00_axi_aclk_0_1 [get_bd_ports clk125] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins full_radio_0/s00_axi_aclk] [get_bd_pins lowlevel_dac_intfc_0/clk125] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins system_ila_0/clk] [get_bd_pins xpm_cdc_gen_0/dest_clk]
  connect_bd_net -net xpm_cdc_gen_0_dest_rst_out [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins full_radio_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins system_ila_0/resetn] [get_bd_pins xpm_cdc_gen_0/dest_rst_out]
...
set_property -name "incremental_checkpoint" -value "$proj_dir/radio_periph_lab.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/radio_periph_lab.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/radio_periph_lab.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/radio_periph_lab.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
